"""SEEDFORGE core — Synthetic test-data generator with referential integrity."""
...
RULES = [
    ("SEE-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("SEE-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("SEE-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
