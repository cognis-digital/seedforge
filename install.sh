#!/usr/bin/env sh
# Universal installer for seedforge. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/seedforge.git"
echo "Installing seedforge ..."
